...
if (checkTimeDiff(cityData.time, cityData.sunrise) === true && checkTimeDiff(cityData.time, cityData.sunset) === false) {
    ...
    tempH1.textContent = cityData.temp;
    ...
    temphigh.textContent = "H: " + cityData.temphigh;
    templow.textContent = "L: " + cityData.templow;
